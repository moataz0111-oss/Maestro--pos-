...
### Offline Mode Improvements ✅ (Fixed - March 22, 2026)
- [x] إظهار رقم الطاولة في قائمة الطلبات المعلقة (OrderCard) 
- [x] حفظ `table_number` عند إنشاء طلب offline
- [x] تحسين شريط Offline لإظهار عدد الطلبات المعلقة بشكل واضح
- [x] إضافة حالة "محفوظ محلياً - في انتظار المزامنة" للطلبات غير المتزامنة
- [x] تحديث syncStatus فوراً عند حفظ طلب جديد

### SuperAdmin UI Fix ✅ (Fixed - March 22, 2026)
- [x] إخفاء عمود "الأجهزة" من صفحة العملاء (لأن Desktop App تم حذفه)
