...
- `DialogContent` لحوار التصنيع: أُضيف `max-h-[90vh] overflow-y-auto` (مطابق لنمط حوار "تقرير فرق العائد" العامل في نفس الملف) → الحوار أصبح قابلاً للتمرير.
...
### التحقق
- Lint نظيف. الإصلاح CSS فقط ويطابق نمطاً موجوداً ومُختبَراً. (ملاحظة: بيانات المستخدم الحقيقية على السيرفر المنشور — يلزم إعادة Deploy لوصول الإصلاح إليها.)
