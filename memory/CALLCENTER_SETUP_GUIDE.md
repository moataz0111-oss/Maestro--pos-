...
```
https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://maestro-pos-1.preview.emergentagent.com/api/callcenter/webhook" \
