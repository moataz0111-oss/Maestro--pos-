...
```
https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://branch-stock-counter.preview.emergentagent.com/api/callcenter/webhook" \
