...
```
https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://nested-recipe-lab.preview.emergentagent.com/api/callcenter/webhook" \
