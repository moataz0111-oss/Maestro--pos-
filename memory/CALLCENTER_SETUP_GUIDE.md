...
```
https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://zero-downtime-deploy-1.preview.emergentagent.com/api/callcenter/webhook" \
