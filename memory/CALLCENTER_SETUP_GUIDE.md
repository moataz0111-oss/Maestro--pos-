...
```
https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://batch-accounting-1.preview.emergentagent.com/api/callcenter/webhook" \
