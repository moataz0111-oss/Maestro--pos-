...
```
https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://leaderboard-games.preview.emergentagent.com/api/callcenter/webhook" \
