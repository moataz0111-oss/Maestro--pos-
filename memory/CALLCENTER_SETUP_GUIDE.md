...
```
https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://offline-pos-multi.preview.emergentagent.com/api/callcenter/webhook" \
