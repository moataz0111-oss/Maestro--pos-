...
```
https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://restoinventory-6.preview.emergentagent.com/api/callcenter/webhook" \
