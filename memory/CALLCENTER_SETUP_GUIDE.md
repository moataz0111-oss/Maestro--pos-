...
```
https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://bilingual-pos-system.preview.emergentagent.com/api/callcenter/webhook" \
