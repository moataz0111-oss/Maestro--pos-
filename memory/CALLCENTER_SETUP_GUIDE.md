...
```
https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://eatosmgr.preview.emergentagent.com/api/callcenter/webhook" \
