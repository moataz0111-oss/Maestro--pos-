...
```
https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://maestro-retail-hub.preview.emergentagent.com/api/callcenter/webhook" \
