...
```
https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://eatery-system-24.preview.emergentagent.com/api/callcenter/webhook" \
