...
```
https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://arabeng-resto.preview.emergentagent.com/api/callcenter/webhook" \
