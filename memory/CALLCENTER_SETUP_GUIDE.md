...
```
https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://sales-report-debug-1.preview.emergentagent.com/api/callcenter/webhook" \
