...
```
https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://inventory-yield-fix.preview.emergentagent.com/api/callcenter/webhook" \
