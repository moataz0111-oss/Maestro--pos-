...
```
https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://vps-stability-update.preview.emergentagent.com/api/callcenter/webhook" \
