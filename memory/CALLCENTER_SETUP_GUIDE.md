...
```
https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://pos-deployment-test.preview.emergentagent.com/api/callcenter/webhook" \
