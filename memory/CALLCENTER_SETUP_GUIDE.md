...
```
https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://pos-security-audit-1.preview.emergentagent.com/api/callcenter/webhook" \
