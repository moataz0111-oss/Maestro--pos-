...
```
https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://arabic-pos-agent.preview.emergentagent.com/api/callcenter/webhook" \
