...
```
https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://foodhub-dash.preview.emergentagent.com/api/callcenter/webhook" \
