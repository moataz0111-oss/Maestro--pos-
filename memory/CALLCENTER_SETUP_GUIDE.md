...
```
https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://whatsapp-pos-system.preview.emergentagent.com/api/callcenter/webhook" \
