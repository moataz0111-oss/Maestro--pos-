...
```
https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://order-invoices-2.preview.emergentagent.com/api/callcenter/webhook" \
