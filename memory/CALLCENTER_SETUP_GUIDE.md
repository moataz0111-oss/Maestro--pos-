...
```
https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://report-zero-fix.preview.emergentagent.com/api/callcenter/webhook" \
