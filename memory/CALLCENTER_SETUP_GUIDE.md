...
```
https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://paid-order-removal.preview.emergentagent.com/api/callcenter/webhook" \
