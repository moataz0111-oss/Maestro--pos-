...
```
https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://kitchen-mgmt-app.preview.emergentagent.com/api/callcenter/webhook" \
