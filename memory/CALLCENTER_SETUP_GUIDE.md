...
```
https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://foodops-pro.preview.emergentagent.com/api/callcenter/webhook" \
