...
```
https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://biometric-hr-system.preview.emergentagent.com/api/callcenter/webhook" \
