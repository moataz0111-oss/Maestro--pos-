...
```
https://restupos.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://restupos.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://restupos.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://restupos.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://restupos.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://restupos.preview.emergentagent.com/api/callcenter/webhook" \
