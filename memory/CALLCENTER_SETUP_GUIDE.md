...
```
https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://trilingual-pos.preview.emergentagent.com/api/callcenter/webhook" \
