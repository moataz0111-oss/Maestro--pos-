...
```
https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://kitchen-routing-fix.preview.emergentagent.com/api/callcenter/webhook" \
