...
```
https://menusync-5.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://menusync-5.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://menusync-5.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://menusync-5.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://menusync-5.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://menusync-5.preview.emergentagent.com/api/callcenter/webhook" \
