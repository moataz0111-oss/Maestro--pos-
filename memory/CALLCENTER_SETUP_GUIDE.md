...
```
https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://offline-pos-system-17.preview.emergentagent.com/api/callcenter/webhook" \
