...
```
https://total-reset.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://total-reset.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://total-reset.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://total-reset.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://total-reset.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://total-reset.preview.emergentagent.com/api/callcenter/webhook" \
