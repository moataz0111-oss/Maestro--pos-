...
```
https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://usb-print-agent.preview.emergentagent.com/api/callcenter/webhook" \
