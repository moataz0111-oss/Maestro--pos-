...
```
https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://pos-barcode-scan.preview.emergentagent.com/api/callcenter/webhook" \
