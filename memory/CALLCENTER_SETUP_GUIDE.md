...
```
https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://recipe-mass-variance.preview.emergentagent.com/api/callcenter/webhook" \
