...
```
https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://electron-pos-system.preview.emergentagent.com/api/callcenter/webhook" \
