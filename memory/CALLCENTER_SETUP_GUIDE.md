...
```
https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://hr-fixes-phase1.preview.emergentagent.com/api/callcenter/webhook" \
