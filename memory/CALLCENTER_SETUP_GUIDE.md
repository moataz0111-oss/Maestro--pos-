...
```
https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://blind-count-pos.preview.emergentagent.com/api/callcenter/webhook" \
