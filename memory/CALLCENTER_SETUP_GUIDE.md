...
```
https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://arabic-receipts.preview.emergentagent.com/api/callcenter/webhook" \
