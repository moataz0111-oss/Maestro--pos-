...
```
https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://maestro-prod.preview.emergentagent.com/api/callcenter/webhook" \
