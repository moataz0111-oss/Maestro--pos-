...
```
https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://null-handler-patch.preview.emergentagent.com/api/callcenter/webhook" \
