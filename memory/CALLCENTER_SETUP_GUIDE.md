...
```
https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://smart-inventory-hub-28.preview.emergentagent.com/api/callcenter/webhook" \
