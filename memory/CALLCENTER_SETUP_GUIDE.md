...
```
https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://multi-cashier-vault.preview.emergentagent.com/api/callcenter/webhook" \
