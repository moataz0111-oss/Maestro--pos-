...
```
https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://warehouse-pos-hub-1.preview.emergentagent.com/api/callcenter/webhook" \
