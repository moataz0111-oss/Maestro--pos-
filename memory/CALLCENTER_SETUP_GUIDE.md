...
```
https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://branch-orders-portal.preview.emergentagent.com/api/callcenter/webhook" \
