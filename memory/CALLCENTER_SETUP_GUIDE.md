...
```
https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://cogs-calc-system.preview.emergentagent.com/api/callcenter/webhook" \
