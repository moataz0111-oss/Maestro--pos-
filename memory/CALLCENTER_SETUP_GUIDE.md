...
```
https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://shift-fix-3.preview.emergentagent.com/api/callcenter/webhook" \
