...
```
https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://table-edit-feature.preview.emergentagent.com/api/callcenter/webhook" \
