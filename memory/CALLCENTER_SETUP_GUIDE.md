...
```
https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://offline-first-pos-3.preview.emergentagent.com/api/callcenter/webhook" \
