...
```
https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://zk-sync-agent.preview.emergentagent.com/api/callcenter/webhook" \
