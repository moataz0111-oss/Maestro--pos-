...
```
https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://print-queue-polling.preview.emergentagent.com/api/callcenter/webhook" \
