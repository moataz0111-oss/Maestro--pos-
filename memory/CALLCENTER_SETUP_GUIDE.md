...
```
https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://invoice-snap-11.preview.emergentagent.com/api/callcenter/webhook" \
