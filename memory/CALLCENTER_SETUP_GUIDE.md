...
```
https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook
```
...
```
CRM Server URL: https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook
HTTP Method: POST
...
```
Webhook URL: https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook
...
```
URL: https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook
...
$webhook_url = "https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook";
...
```bash
curl -X POST "https://inventory-accounting-11.preview.emergentagent.com/api/callcenter/webhook" \
