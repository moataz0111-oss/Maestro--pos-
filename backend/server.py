...
async def download_print_agent(request: Request):
    ...
    bat_lines = [
        ...
        '',
        'REM ======================================================',
        'REM   Maestro Print Agent v3.5.0 - Full Clean Install',
        'REM ======================================================',
        '',
        'REM === Request Admin ===',
        'net session >nul 2>&1',
        ...
        ')',
        '',
        'title Maestro Print Agent v3.5.0 - Clean Install',
        'color 0A',
        'echo.',
        'echo  ========================================',
        'echo    Maestro Print Agent v3.5.0',
        ...
        '',
        'REM ========================================',
        'REM   STEP 3: DOWNLOAD FRESH v3.5.0',
        'REM ========================================',
        'echo  [3/5] Downloading v3.5.0 (no cache)...',
        ...
        'powershell -NoProfile -Command "$c=Get-Content \'%D%\\server.ps1\' -Head 5 -Raw; if($c -match \'v3\\.2\\.1\'){Write-Host \'    Downloaded: v3.5.0\' -ForegroundColor Green}else{Write-Host \'    WARNING: Version mismatch!\' -ForegroundColor Red}"',
        'echo    [OK]',
        'echo.',
        '',
        'REM ========================================',
        ...
        'REM ========================================',
        'echo  [4/5] Starting new agent v3.5.0...',
        ...
        'powershell -NoProfile -Command "try { $r=Invoke-WebRequest -Uri \'http://localhost:9999/status\' -UseBasicParsing -TimeoutSec 10; $j=$r.Content|ConvertFrom-Json; Write-Host (\'  Agent Version: \'+$j.version) -ForegroundColor Green; if($j.version -eq \'3.5.0\'){Write-Host \'  v3.5.0 OK!\' -ForegroundColor Green}else{Write-Host \'  WARNING: Expected 3.5.0 got \'+$j.version -ForegroundColor Red} } catch { Write-Host \'  Agent starting... wait 30 sec and refresh browser\' -ForegroundColor Yellow }"',
        'echo.',
        'echo  ========================================',
        'echo    DONE! Refresh the POS page.',
        'echo    Agent v3.5.0 installed.',
        'echo  ========================================',
        'echo.',
        'pause',
        'exit /b',
