...
async def download_print_agent(request: Request):
    ...
    bat_lines = [
        ...
        '',
        'REM ======================================================',
        'REM   Maestro Print Agent v4.2.0 - Full Clean Install',
        'REM ======================================================',
        '',
        'REM === Request Admin ===',
        'net session >nul 2>&1',
        ...
        ')',
        '',
        'title Maestro Print Agent v4.2.0 - Clean Install',
        'color 0A',
        'echo.',
        'echo  ========================================',
        'echo    Maestro Print Agent v4.2.0',
        ...
        'netsh http add urlacl url=http://127.0.0.1:9999/ user=Everyone listen=yes >nul 2>&1',
        '',
        ...
        '',
        'REM ========================================',
        'REM   STEP 3: DOWNLOAD FRESH v4.2.0',
        'REM ========================================',
        'echo  [3/6] Downloading v4.2.0 (no cache)...',
        ...
        'powershell -NoProfile -Command "$c=Get-Content \'%D%\\server.ps1\' -Raw; if($c -match \'v4\\.0\'){Write-Host \'    Downloaded OK\' -ForegroundColor Green}else{Write-Host \'    WARNING: Version mismatch!\' -ForegroundColor Red}"',
        'echo    [OK]',
        'echo.',
        '',
        'REM ========================================',
        ...
        'REM ========================================',
        'echo  [4/6] Starting new agent v4.2.0...',
        ...
        'powershell -NoProfile -Command "$d=$env:LOCALAPPDATA+\'\\MaestroPrintAgent\'; $watchdog=@\'+[char]10+\'try { $r=Invoke-WebRequest -Uri http://localhost:9999/status -UseBasicParsing -TimeoutSec 5; if($r.StatusCode -eq 200){exit 0} } catch {} \'+[char]10+\'$script=$env:LOCALAPPDATA+\"\\MaestroPrintAgent\\server.ps1\"\'+[char]10+\'if(Test-Path $script){ Start-Process powershell -ArgumentList \"-ExecutionPolicy Bypass -NoProfile -WindowStyle Hidden -File `\"$script`\"\" -WindowStyle Hidden }\'+[char]10+\'\'@; [IO.File]::WriteAllText(($d+\'\\watchdog.ps1\'),$watchdog)"',
        '',
        ...
        'powershell -NoProfile -Command "try { $r=Invoke-WebRequest -Uri \'http://localhost:9999/status\' -UseBasicParsing -TimeoutSec 10; $j=$r.Content|ConvertFrom-Json; Write-Host (\'  Agent Version: \'+$j.version) -ForegroundColor Green; if($j.version -eq \'4.2.0\'){Write-Host \'  v4.2.0 OK!\' -ForegroundColor Green}else{Write-Host \'  WARNING: Expected 4.2.0 got \'+$j.version -ForegroundColor Red} } catch { Write-Host \'  Agent starting... wait 30 sec and refresh browser\' -ForegroundColor Yellow }"',
        'echo.',
        'echo  ========================================',
        'echo    DONE! Refresh the POS page.',
        'echo    Agent v4.2.0 installed.',
        'echo  ========================================',
        'echo.',
        'pause',
        'exit /b',
