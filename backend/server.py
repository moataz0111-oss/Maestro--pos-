...
async def download_print_agent(request: Request):
    ...
    bat_lines = [
        ...
        '',
        'REM ======================================================',
        'REM   Maestro Print Agent v3.9.2 - Full Clean Install',
        'REM ======================================================',
        '',
        'REM === Request Admin ===',
        'net session >nul 2>&1',
        ...
        ')',
        '',
        'title Maestro Print Agent v3.9.2 - Clean Install',
        'color 0A',
        'echo.',
        'echo  ========================================',
        'echo    Maestro Print Agent v3.9.2',
        ...
        '',
        'REM ========================================',
        'REM   STEP 3: DOWNLOAD FRESH v3.9.2',
        'REM ========================================',
        'echo  [3/5] Downloading v3.9.2 (no cache)...',
        ...
        'powershell -NoProfile -Command "$c=Get-Content \'%D%\\server.ps1\' -Raw; if($c -match \'v3\\.8\\.1\'){Write-Host \'    Downloaded: v3.9.2\' -ForegroundColor Green}else{Write-Host \'    WARNING: Version mismatch!\' -ForegroundColor Red}"',
        'echo    [OK]',
        'echo.',
        '',
        'REM ========================================',
        ...
        'REM ========================================',
        'echo  [4/5] Starting new agent v3.9.2...',
