...
const translations = {
  ar: {
    ...
    'إدارة أجهزة العملاء': 'إدارة أجهزة العملاء',
    'جميع الأجهزة المرخصة': 'جميع الأجهزة المرخصة',
    'لا يوجد عملاء فعليين': 'لا يوجد عملاء فعليين',
    'لا توجد حسابات تجريبية': 'لا توجد حسابات تجريبية',
    'لا توجد أجهزة مسجلة': 'لا توجد أجهزة مسجلة',
    'إدارة الأجهزة المرخصة': 'إدارة الأجهزة المرخصة',
    'فشل في جلب بيانات الأجهزة': 'فشل في جلب بيانات الأجهزة',
    'لا توجد منتجات مصنعة حالياً. أضف منتجات من قسم المخزن والتصنيع أولاً': 'لا توجد منتجات مصنعة حالياً. أضف منتجات من قسم المخزن والتصنيع أولاً',
    'ربط بمنتج مصنع (للخصم التلقائي)': 'ربط بمنتج مصنع (للخصم التلقائي)',
  ...
  en: {
    ...
    'إدارة أجهزة العملاء': 'Customer Devices Management',
    'جميع الأجهزة المرخصة': 'All Licensed Devices',
